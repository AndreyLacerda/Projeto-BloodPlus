...
public class MainScreenController {
	...
	public void Login(ActionEvent event) throws SQLException, IOException {
		...
		if (user.equals("Doador")) {
			if (email.getText() != null && pass.getText() != null && !email.getText().contains("*") && !email.getText().contains("//") && !email.getText().contains("--") && !pass.getText().contains("--") && !pass.getText().contains("//") && !pass.getText().contains("--")) {
				...
				error.setText("Caracteres Inválidos");
			}
		}
		else
